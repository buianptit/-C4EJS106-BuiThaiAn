...
// // 3.1 Kiểu dữ liệu của lớp ngoài cùng là : Object 

// // 3.2 Thuộc tính hits là nơi lưu trữ kết quả, nó là : Array

// // 3.3 Trong mỗi hits,làm thế nào để tìm job’s title, locations, salary, benefits, skills and requirements ?
// // console.log(jobSearch.hits[1].benefits);
// let hits = jobSearch.hits; 
// for( let obj of hits){ 
//     // Lặp qua từng đối tượng trong mảng hits,hits là key của object: jobSearch
//     console.log(obj.jobTitle);
//     console.log(obj.locations);
//     console.log(obj.jobSalary);
//     console.log(obj.benefits);
//     console.log(obj.skills);
//     console.log(obj.jobRequirement);
// }
...
// 15.1 In ra tất cả job hits :
// console.log('Job hits:');
// console.log(jobData.hits);

// // 15.2 In ra first job hit :
...
// for ( let item of jobData.hits[0].benefits ){
//     console.log('- ' + item.benefitValue);
...
// let hits = jobData.hits;
// for( let obj of hits ){
//     console.log( `Title: ${obj.jobTitle}`);
//     console.log(`Salary: ${obj.jobSalary}`);
//     console.log('Locations:')
//     for( let key of obj.locations ){
//         console.log(`- ${key}`)
//     }
//     console.log('Skills:');
//     for ( let item of obj.skills ){
//         console.log(`- ${item}`);
//     }
//     console.log('--------------------------------------');
// }
